...
export const SCENARIO_STARTERS:Record<ScenarioId,WorkflowStarter>={
  ...
  "educational":{scenario:"educational",starterPrompt:"Organize the teaching into clear sections, highlight definitions and key numbers, and keep visual reinforcement useful rather than decorative.",sceneTaxonomy:["hook","reframe","process","proof","cta"],captionHint:"primary · emphasize key concepts",visualIntensity:"medium"},
