...
const stage=(id:string,executorKey:string,dependsOn:string[],kind:WorkflowDefinition["stages"][number]["kind"],retryable=true):WorkflowDefinition["stages"][number]=>({id,kind,dependsOn,optional:false,retryable,reviewRequired:false,invalidates:[],executorKey});
...
export const registerW2CapabilityWorkflowDefinitions=(registry:WorkflowDefinitionRegistry)=>{
