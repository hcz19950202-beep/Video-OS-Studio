import type {AudioNormalizationInput,FfmpegAdapter,HyperFramesAdapter,MediaProbeResult,RemotionRenderAdapter,VideoNormalizationInput,VideoUseAdapter} from "@/adapters/contracts";
...
export class MockFfmpegAdapter implements FfmpegAdapter{
  ...
  readonly normalizedAudio:Array<AudioNormalizationInput>=[];
  ...
  async normalizeAudio(input:AudioNormalizationInput){this.normalizedAudio.push(input);return{outputPath:input.outputPath};}
}
