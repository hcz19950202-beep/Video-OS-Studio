...
const RenderControlsInner=({project}:{project:Project})=>{
  ...
  const[profile,setProfile]=useState<ExportProfile>({sizing:"project",container:"mp4",codec:"h264",audio:"aac",quality:"high"});
