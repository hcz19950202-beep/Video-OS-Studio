...
import {AgentNativeLeftPanel} from "@/components/studio/AgentNativeLeftPanel";
import {AgentNativeContextDock} from "@/components/studio/AgentNativeContextDock";
...
export const ResizableWorkspaceShell=({topbar,rail,content,viewer,inspector,timeline}:Props)=>{
  ...
  return <main className="v21-workspace" style={style} data-workspace-version="2.5-c1">
    {topbar}
    <AgentNativeCommandStrip/>
    <section className="v21-workspace-body"><div className="v21-upper-workspace">
      {!display.leftCollapsed?<aside className="v21-content-panel" data-workspace-region="agent"><AgentNativeLeftPanel legacyRail={rail} legacyContent={content}/></aside>:null}
      ...
      {!display.inspectorCollapsed?<aside className="v21-inspector-panel" data-workspace-region="context"><AgentNativeContextDock inspector={inspector}/></aside>:null}
    </div>
