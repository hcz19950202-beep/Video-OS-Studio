...
const zh={
  ...
  sceneInspector:"场景检查器",name:"名称",type:"类型",summary:"摘要",visualIntensity:"视觉强度",sceneStyle:"场景样式",inheritBrand:"继承品牌",range:"范围",segments:"段落",low:"低",medium:"中",high:"高",
  multiSelect:"多选",clips:"个片段",commonProperties:"公共属性",motionCommon:"动效公共属性",scale:"缩放",opacity:"透明度",mixedNone:"混合 / 无",bulkHint:"一次批量编辑作为一个 Project Transaction，只增加一次 revision。",mixedTypes:"当前选中了不同类型片段。M3 只显示安全的公共属性，类型专属字段已隐藏。",
  linkedStyle:"联动样式",live:"实时联动",style:"样式",none:"无",create:"创建",styleScale:"样式缩放",styleOpacity:"样式透明度",fill:"填充色",fontSize:"字号",fontWeight:"字重",lineHeight:"行高",maxWidth:"最大宽度 %",font:"字体",position:"位置",alignment:"对齐",stroke:"描边",shadow:"阴影",top:"顶部",center:"居中",bottom:"底部",left:"左",right:"右",
...
const en={
  ...
  sceneInspector:"Scene Inspector",name:"Name",type:"Type",summary:"Summary",visualIntensity:"Visual Intensity",sceneStyle:"Scene Style",inheritBrand:"Inherit Brand",range:"Range",segments:"Segments",low:"Low",medium:"Medium",high:"High",
  multiSelect:"Multi Select",clips:"clips",commonProperties:"Common Properties",motionCommon:"Motion Common",scale:"Scale",opacity:"Opacity",mixedNone:"Mixed / None",bulkHint:"One bulk edit is committed as one Project transaction / one revision.",mixedTypes:"Mixed clip types selected. M3 only exposes safe common properties; type-specific fields remain hidden.",
  linkedStyle:"Linked Style",live:"Live",style:"Style",none:"None",create:"Create",styleScale:"Style Scale",styleOpacity:"Style Opacity",fill:"Fill",fontSize:"Font Size",fontWeight:"Font Weight",lineHeight:"Line Height",maxWidth:"Max Width %",font:"Font",position:"Position",alignment:"Alignment",stroke:"Stroke",shadow:"Shadow",top:"Top",center:"Center",bottom:"Bottom",left:"Left",right:"Right",
