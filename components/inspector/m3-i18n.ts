...
const zh={
  ...
  multiSelect:"多选",clips:"个片段",commonProperties:"公共属性",motionCommon:"动效公共属性",scale:"缩放",opacity:"透明度",rotation:"旋转",mixed:"混合",mixedNone:"混合 / 无",bulkHint:"一次批量编辑作为一个 Project Transaction，只增加一次 revision。",mixedTypes:"当前选中了不同类型片段。M3 只显示安全的公共属性，类型专属字段已隐藏。",
